...
export const POPULATIONS: Population[] = [
  ...
  },
  {
    ...
    aet: {
      ...
      valeurs: [
        { profil: "Femmes ménopausées 51-59 ans", kcal: "2056 kcal", kJ:  "8,6 MJ" },
        { profil: "Femme 60-65 ans", kcal: "1928 kcal", kJ: "8,1 MJ" },
        { profil: "Femme > 65 ans", kcal: "1877 kcal", kJ: "7,8 MJ" },
